...
const displayFormBtnTask = document.getElementById('displayFormBtn3');
const overlayTask = document.getElementById('overlayViewSheet');
const closeFormBtnTask = document.getElementById('closeFormBtn3');
